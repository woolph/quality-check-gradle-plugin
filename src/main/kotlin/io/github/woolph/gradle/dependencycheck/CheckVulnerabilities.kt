...
import io.github.woolph.gradle.dependencycheck.DependencyCheckExtension.Companion.filterExists
...
abstract class CheckVulnerabilities: DefaultTask() {
  ...
  @get:OutputFile
  abstract val reportJunit: RegularFileProperty
  ...
  fun checkVulnerabilities() {
    try {
      val dCAnalyze = project.tasks.named<org.owasp.dependencycheck.gradle.tasks.Analyze>("dependencyCheckAnalyze")
      dCAnalyze.get().analyze()
    } finally {
